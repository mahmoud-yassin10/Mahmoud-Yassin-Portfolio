                ...
                <ol className="list-decimal pl-5 space-y-6">
                  ...
                  <li>
                    ...
                    <div className="mt-3 space-y-1 text-muted-foreground">
                      ...
                      <p>AI planning results are generated by a remote service and returned to the app.</p>
                  ...
                  <li>
                    ...
                    <p className="mt-2 text-muted-foreground">
                      ...
                      recovery as described in the Data retention section. This deletes your authentication
                      account and associated Firestore data (budgets, transactions, goals, categories, and
                      profile data).
                    </p>
                    <p className="mt-2 text-muted-foreground">

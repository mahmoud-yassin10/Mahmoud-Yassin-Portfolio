            ...
            <div className="max-w-4xl mx-auto bg-card/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-border">
              ...
              <div className="space-y-6 text-base text-foreground">
                <p className="text-muted-foreground">
                  This page is for deleting your data while keeping your Flousy account active.
                </p>
                <p className="text-muted-foreground">
                  You can delete your Flousy data directly in the app. Follow these steps:
                </p>
                <ol className="list-decimal pl-5 space-y-1 text-muted-foreground">
                  ...
                  <li>Tap Account</li>
                  <li>
                    Select &quot;Delete my data&quot; (or &quot;Delete data&quot;) and confirm. If
                    the exact label is different, select the data deletion option.
                  </li>
                </ol>
                ...
                <div>
                  ...
                  <p className="mt-2 text-muted-foreground">
                    Data only. Your account remains active.
                  </p>
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-muted-foreground">
                    <li>Firestore data: budgets, transactions, goals, categories, profile data</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-muted-foreground">
                    <li>The authentication account (email/login) remains active</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-muted-foreground">
                    Subject line: Flousy Data Deletion Request
                  </p>
                  <p className="mt-2 text-muted-foreground">
